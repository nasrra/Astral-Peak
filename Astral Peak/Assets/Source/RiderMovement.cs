...
public class RiderMovement : Movement{
    ...
    public void jnd_jump_back()     => dash(transform.rotation.y == 0? Vector2.left : Vector2.right, 20, 0.40f);
    public void jnd_front_leap()    => dash(transform.rotation.y == 0? Vector2.right : Vector2.left, 40, 0.30f);
}
