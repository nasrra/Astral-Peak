...
public class TheCavalryBackground : MonoBehaviour{
    ...
    public void play_howl() => AudioClipHandler.play(this, SoundID.WOLF_HOWL, out source);
    public void play_hop() => AudioClipHandler.play(this, SoundID.MAGIC_1, out source);
    ...
    public void play_impact_sound() => AudioClipHandler.play(UnityHook.instance, SoundID.SNOW_IMPACT_HEAVY, out source);
