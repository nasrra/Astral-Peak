...
public class CavalryAudio : MonoBehaviour
{
    ...
    public void emit_bow_shot()           => AudioClipHandler.play(this, SoundID.BOW_SHOT, out source);                                                        
    ...
    public SoundID choose_bark()
    {
        ...
        switch (x)
        {
            case 0: return SoundID.DOG_BARK_1;
            case 1: return SoundID.DOG_BARK_2;
            case 2: return SoundID.DOG_BARK_3;
        }
