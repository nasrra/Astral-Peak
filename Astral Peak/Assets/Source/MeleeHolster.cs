...
public class MeleeHolster : MonoBehaviour{
    ...
    [SerializeField] private int health_damage;
    [SerializeField] private float 
        guard_damage, knockback_force, knockback_duration,
    ...
    public void set_damage(int amt) => health_damage = amt;
    ...
    public void hit(Collider2D other){
        ...
        if(creature.damage(health_damage, gameObject) == true)
